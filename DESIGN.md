...
I initially spent time and effort building [slack-bot](https://github.com/Nickbohm555/slack-bot) with the design here if you want to read my initial thoughts: [DESIGN.md](https://github.com/Nickbohm555/slack-bot/blob/main/DESIGN.md). You can read this to get my initial design for how I built this slack-bot, then in here I include my improvements that got me from 50-70% accuracy to 85-95% accuracy while reducing latency down to ~30-60 seconds.
